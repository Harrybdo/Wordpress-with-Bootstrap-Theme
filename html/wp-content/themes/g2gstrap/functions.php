...
if( !function_exists( "theme_js" ) ) {  
  function theme_js(){
    ...
    wp_register_script('jquery','https://code.jquery.com/jquery-1.11.3.min.js','1.11.3',true);
    wp_register_script('bootstrap','https://maxcdn.bootstrapcdn.com/bootstrap/3.3.4/js/bootstrap.min.js',array('jquery'),'3.3.4',true);
    wp_register_script('wpbs-scripts',get_template_directory_uri() . '/library/js/scripts.js', array('jquery'),'1.0',true);
    wp_register_script('g2gscripts',get_template_directory_uri() . '/library/js/g2gscripts.js', array('jquery'),'1.0',true);
    wp_register_script('modernizr',get_template_directory_uri() . '/library/js/modernizr.full.min.js', array('jquery'),'2.8.3',true);
      
    wp_enqueue_script('jquery');
    wp_enqueue_script('bootstrap');
    wp_enqueue_script('wpbs-scripts');
    wp_enqueue_script('g2gscripts');
